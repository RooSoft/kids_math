defmodule KidsMathWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KidsMathWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KidsMathWeb.Gettext, "errors", msg, opts)
    end
  end
